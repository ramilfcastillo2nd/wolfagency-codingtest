...
{
    [DbContext(typeof(WolfAgencyCodingTestContext))]
    partial class WolfAgencyCodingTestContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Infrastructure.Entities.AppUserToken", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Infrastructure.Entities.UserProfile", b =>
                {
                    b.HasOne("Infrastructure.Entities.AppUser", "AppUser")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
